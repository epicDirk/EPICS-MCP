...
# core lane is 63_879 and the full lane 72_167. Re-MEASURE these two after ANY change that can
...
async def test_tools_list_within_budget() -> None:
    ...
    72_167; a new tool or an SDK change that inflates the wire could grow that UNNOTICED with an
