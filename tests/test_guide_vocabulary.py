...
#: Re-measured 2026-08-19 with ``len(_response_keys())`` and ``len(_index_rows())``: 477 and 18
#: (16 rows on 2026-08-16; the two new ones index the write-answer fields, GQ-33).
