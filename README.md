# EPICS-MCP-Server
# Overview
&nbsp;&nbspThe EPICS MCP Server is a Python-based server designed to interact with EPICS (Experimental Physics and Industrial Control System) process variables (PVs). It provides a set of tools to retrieve PV values, set PV values, and fetch detailed information about PVs. The server is built 
...
# Features
&nbsp;&nbspThe EPICS MCP Server provides the following tools:
