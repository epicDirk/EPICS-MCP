...
* ``epics-doctor``'s naming plane (:func:`epics_mcp.services.doctor._identify_naming`) imports
  the title + path constants.
* :meth:`epics_mcp.services.naming_client.NamingServiceClient._get_device_name`'s S13 gate calls
