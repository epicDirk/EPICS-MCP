...
with an empty list. :func:`~epics_mcp.services.archiver_time.normalize_archiver_time` converts
...
:mod:`epics_mcp.services.naming_client`.
"""
...
from epics_mcp.services._http import get_shared_session, is_http_404, rest_get_json
...
class ArchiverClient:
    ...
    def get_appliance_info(self) -> dict[str, object]:
        """Return the appliance's own topology (Archiver MGMT ``getApplianceInfo``).
