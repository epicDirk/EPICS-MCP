    ...
    topic: Annotated[
        ...
        Field(
            description=(
                ...
                "holds for 'errors', which serves the signature section's lead only: the thirty "
                "signatures themselves are the eleven 'err-' keys, one per plane or per kind, so "
                "ask for the group you need ('err-archiver' for an appliance or a history "
                "refusal, 'err-gates' for a refused write, 'err-displays' for a PV inventory that "
                "answers 0). Omit the "
