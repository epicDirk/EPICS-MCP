...
async def get_guide(
    topic: Annotated[
        ...
        Field(
            description=(
                ...
                "ask for the group you need ('err-archiver' for an appliance or a history "
                "refusal, 'err-gates' for a refused write AND for a server that declines to "
                "start, 'err-displays' for a PV inventory that answers 0, 'err-olog' for a READ "
                "that answers 401 or empty). Omit the argument, or pass an empty string, for "
                "everything; surrounding whitespace is "
    ...
    The whole document is around 119 KB, which is why 'topic' exists and why omitting it should be
