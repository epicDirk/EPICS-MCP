...
(:func:`epics_mcp.services.checkers.query_naming_lookup`), the same place ``diagnose_connection``
...
from epics_mcp.services.checkers import NameLookupResult, query_naming_lookup
...
async def _lookup_device_name(name: str, timeout: float = 5.0) -> NameLookupResult:
    ...
    Thin MCP adapter over :func:`epics_mcp.services.checkers.query_naming_lookup`.
    """
