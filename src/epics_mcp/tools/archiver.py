...
(:func:`epics_mcp.services.checkers.query_archived`) so :mod:`~epics_mcp.services.diagnose`
...
async def _is_archived(pv: str, timeout: float = 5.0) -> ArchiveStatusResult:
    ...
    Thin MCP adapter over :func:`epics_mcp.services.checkers.query_archived`.
    """
