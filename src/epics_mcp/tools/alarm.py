...
(:func:`epics_mcp.services.checkers.query_alarm_configured`) so
:mod:`~epics_mcp.services.diagnose` reuses it without an upward ``services → tools`` import (M9).
...
async def _is_alarm_configured(
    ...
    Thin MCP adapter over :func:`epics_mcp.services.checkers.query_alarm_configured`.
    """
...
async def _get_alarm_history(
    ...
    *,
    ...
    Thin MCP adapter over :func:`epics_mcp.services.checkers.query_alarm_history`. The optional
