...
def setup_epics_mcp(*, presets: Mapping[str, Preset]) -> str:
    ...
    return (
        ...
        "encoding my shell prefers, and in Windows PowerShell that is bytes no JSON parser "
        "accepts. If the file already exists the command refuses instead of overwriting, because "
